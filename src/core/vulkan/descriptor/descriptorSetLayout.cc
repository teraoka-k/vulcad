#if !defined(VULCAD_CORE_VULKAN_PIPELINE_DESCRIPTOR_SET_LAYOUT)
#define VULCAD_CORE_VULKAN_PIPELINE_DESCRIPTOR_SET_LAYOUT
...
#endif // VULCAD_CORE_VULKAN_PIPELINE_DESCRIPTOR_SET_LAYOUT
