#if !defined(TUTORIAL_VULKAN_BUFFER_UNIFORM_BUFFER)
#define TUTORIAL_VULKAN_BUFFER_UNIFORM_BUFFER
...
public:
  ...
  void writeMVP(VkDevice device, VkExtent2D extent) {
...
#endif // TUTORIAL_VULKAN_BUFFER_UNIFORM_BUFFER
